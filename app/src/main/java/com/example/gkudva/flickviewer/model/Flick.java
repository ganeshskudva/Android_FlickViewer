...
public class Flick implements Parcelable {
    ...
    public String getPosterPath(int width) {
        return String.format(Locale.getDefault(), "https://image.tmdb.org/t/p/w%d/%s", width, posterPath);
    }
    ...
    public String getBackdropPath(int width) {
        return String.format(Locale.getDefault(), "https://image.tmdb.org/t/p/w%d/%s", width, backdropPath);
    }
    ...
    protected Flick(Parcel in)
    {
        ...
        in.readList(tmp, List.class.getClassLoader());
        this.genreIds = tmp;
